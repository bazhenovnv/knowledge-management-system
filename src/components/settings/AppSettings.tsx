...
interface AppSettingsData {
  ...
  soundNotificationType: 'notification' | 'success' | 'alert' | 'chime';
}
...
export default function AppSettings() {
  const [settings, setSettings] = useState<AppSettingsData>({
    ...
    soundNotificationType: 'notification'
  });
        ...
        <CardContent className="space-y-3">
          ...
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              onCheckedChange={(checked) => handleChange('enableSoundNotifications', checked)}
            />
          </div>
            ...
            <div className="space-y-3 pl-4 border-l-2 border-gray-200">
              <div>
                ...
                <div className="flex gap-2 mt-2">
                  <Select 
                    value={settings.soundNotificationType}
                    onValueChange={(value) => handleChange('soundNotificationType', value as SoundType)}
                  >
                  ...
                  <Button
                    ...
                    size="sm"
                    onClick={() => {
                      playSound(settings.soundNotificationType);
                      toast.success(`Звук "${getSoundName(settings.soundNotificationType)}" воспроизведен`);
                    }}
                  >
