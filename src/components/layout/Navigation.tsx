    ...
    <>
      ...
      <div className="flex items-stretch gap-2 mb-8">
        ...
        <TabsTrigger
          ...
          className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-blue-600 data-[state=active]:to-purple-600 data-[state=active]:text-white bg-gray-200 text-gray-700 transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105 active:scale-95 border-2 border-black"
        >
          <Icon name="LayoutDashboard" size={16} className="mr-2" />
