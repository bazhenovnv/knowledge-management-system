  ...
  return (
    <>
      ...
      <TabsList className={`grid w-full ${(userRole === "admin" || userRole === "teacher") ? 'grid-cols-5' : 'grid-cols-4'} mb-8 bg-white/50 backdrop-blur-sm gap-2`}>
        ...
        <TabsTrigger
          value="dashboard"
          className="data-[state=active]:bg-purple-600 data-[state=active]:text-white bg-gray-200 text-gray-700 transition-all duration-300 shadow-md hover:scale-105 active:scale-95"
        >
          <Icon name="LayoutDashboard" size={16} className="mr-2" />
        ...
        <TabsTrigger
          value="tests"
          className="data-[state=active]:bg-purple-600 data-[state=active]:text-white bg-gray-200 text-gray-700 transition-all duration-300 test-button-animate test-button-glow test-button-hover relative shadow-md hover:scale-105 active:scale-95"
        >
          <Icon name="FileText" size={16} className="mr-2" />
          <span className="hidden sm:inline text-lg">
            Тесты
